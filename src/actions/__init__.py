...
from .create_ticket import _create_ticket_view, create_ticket
from .delete_ticket import delete_ticket
from .get_attachments import _get_attachments_view, get_attachments
from .get_ticket import _get_ticket_view, get_ticket
from .link_tickets import _link_tickets_view, link_tickets
from .list_projects import (
    ListProjectsSummaryOutput,
    _list_projects_view,
    list_projects,
)
from .list_tickets import (
    ListTicketsSummaryOutput,
    _list_tickets_view,
    list_tickets,
)
...
from .search_users import (
    LookupUsersSummaryOutput,
    _lookup_users_view,
    lookup_users,
)
from .set_ticket_status import _set_ticket_status_view, set_status
from .update_ticket import _update_ticket_view, update_ticket
...
def register_actions(app: App) -> App:
    ...
    app.register_action(
        ...
        view_template="jira_create_ticket.html",
    ...
    app.register_action(
        ...
        view_template="jira_get_attachments.html",
    ...
    app.register_action(
        ...
        view_template="jira_get_ticket.html",
    ...
    app.register_action(
        ...
        view_template="jira_link_tickets.html",
    ...
    app.register_action(
        ...
        view_template="jira_list_projects.html",
    ...
    app.register_action(
        ...
        view_template="jira_list_tickets.html",
    ...
    app.register_action(
        ...
        view_template="jira_search_users.html",
    ...
    app.register_action(
        ...
        view_template="jira_set_status_items.html",
    ...
    app.register_action(
        ...
        view_template="jira_update_ticket.html",
